# ROLIE Extension Template
This repository contains a template document and makefile for ROLIE extensions. The intent is that anyone wanting to extend [ROLIE](https://datatracker.ietf.org/doc/draft-ietf-mile-rolie/) will be able to fork, or duplicate, this repository and create a ROLIE extension. Special thanks to Stephen Banghart for creating the initial template.
...
([info](https://example.com/wg/listinfo)). This will ensure that
